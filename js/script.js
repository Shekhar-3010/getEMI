    ...
    amortSchedule.forEach((installment, index) => {
      tableBody += `
          <tr class='text-center ${installment.partPaymentMade != "0" && partPaymentFrequency !== "off" ? "table-success" : ""}'>
            ...
            <td class='text-center detailed-info'> Rs ${installment.openingBalance}</td>
            <td class='text-center mon_pay hide'> Rs ${installment.monthlyPayment}</td>
            <td class='text-center'> Rs ${installment.principal}</td>
            <td class='text-center'> Rs ${installment.monthlyInterest}</td>
            ...
            <td class='text-center'> Rs ${installment.monthlyPaymentWithPartPayment}</td>
            <td class='text-center'> Rs ${installment.remainingLoanAmount}</td>
